...
//
//
/// \file PhysXJointOptions.h
/// \brief Header file for PhysXJointOptions, implementing possible joint options nodes
/// handled by PhysX.
///
//
//////////////////////////////////////////////////////////////////////////////

#ifndef __PHYSXJOINTOPTIONS_H__
#define __PHYSXJOINTOPTIONS_H__
...
namespace H3D {
  ...
  ///
  /// <b>Examples:</b>
  ///   - <a href="../../examples/DistanceJoint/PhysXJointOptions.x3d">PhysXJointOptions.x3d</a>
  ///     ( <a href="examples/PhysXJointOptions.x3d.html">Source</a> )
  ///
  /// \par Internal routes:
  /// \dotfile PhysXJointOptions.dot
  class H3DPHYS_API PhysXJointOptions : public H3DEngineOptions {
  public:
    /// Constructor.
    PhysXJointOptions(
      ...
      Inst< SFString > _projectionFlag = 0,
      Inst< SFBool > _enabledProjection = 0,
      Inst< SFBool > _enabledCollision = 0 );
    ...
    /// 
    /// \dotfile PhysXJointOptions_projectionTolerance.dot
    auto_ptr < SFVec2f > projectionTolerance;

    /// The projection flag value to set the joint to.
    /// 
    /// <b>Access type:</b> inputOutput
    /// <b>Default value:</b> "ePROJECTION" \n
    /// <b>Valid values:</b> "ePROJECTION" "ePROJECT_TO_ACTOR0" "ePROJECT_TO_ACTOR1" \n
    /// 
    /// \dotfile PhysXJointOptions_projectionFlag.dot
    auto_ptr < SFString > projectionFlag;
    ...
    /// 
    /// \dotfile PhysXJointOptions_enabledProjection.dot
    auto_ptr < SFBool > enabledProjection;

    /// If enabledCollision is true then collision between the rigidbodies controlled by the
    /// joint is enabled.
    /// 
    /// <b>Access type:</b> inputOutput
    /// <b>Default value:</b> false \n
    /// 
    /// \dotfile PhysXJointOptions_enabledCollision.dot
    auto_ptr< SFBool > enabledCollision;
  ...
  ///
  /// \par Internal routes:
  /// \dotfile PhysXSliderJointOptions.dot
  class H3DPHYS_API PhysXSliderJointOptions : public PhysXJointOptions {
  public:

    /// Constructor.
    PhysXSliderJointOptions(
      Inst< SFNode  > _metadata = 0,
      Inst< ValueUpdater   > _valueUpdater = 0,
    ...
    /// 
    /// \dotfile PhysXSliderJointOptions_explicitAnchorPoint.dot
    ...
    /// <b>Default value:</b> Vec3f(0.0f, 0.0f, 0.0f) \n
    /// 
    /// \dotfile PhysXSliderJointOptions_body1Offset.dot
    ...
    /// <b>Default value:</b> Vec3f(0.0f, 0.0f, 0.0f) \n
    /// 
    /// \dotfile PhysXSliderJointOptions_body2Offset.dot
    ...
    /// 
    /// \dotfile PhysXSliderJointOptions_body2ForceScale.dot
    ...
    /// 
    /// \dotfile PhysXSliderJointOptions_forceType.dot
  ...
  ///
  /// \par Internal routes:
  /// \dotfile PhysXJoint6DOFLimitOptions.dot
  class H3DPHYS_API PhysXJoint6DOFLimitOptions : public PhysXJointOptions {
  public:
    ...
    /// \note NOT IMPLEMENTED YET ON THE PHYSX SIDE
    ///
    /// <b>Access type:</b> inputOutput
    /// <b>Default value:</b> Vec2f(0.0f, 0.0f) \n
    /// 
    /// \dotfile PhysXJoint6DOFLimitOptions_linear_x.dot
    ...
    /// <b>Default value:</b> Vec2f(0.0f, 0.0f) \n
    /// 
    /// \dotfile PhysXJoint6DOFLimitOptions_linear_y.dot
    ...
    /// <b>Default value:</b> Vec2f(0.0f, 0.0f) \n
    /// 
    /// \dotfile PhysXJoint6DOFLimitOptions_linear_z.dot
    ...
    /// <b>Default value:</b> Vec2f(0.0f, 0.0f) \n
    /// 
    /// \dotfile PhysXJoint6DOFLimitOptions_angular_x.dot
    ...
    /// <b>Default value:</b> Vec2f(0.0f, 0.0f) \n
    /// 
    /// \dotfile PhysXJoint6DOFLimitOptions_angular_y.dot
    ...
    /// <b>Default value:</b> Vec2f(0.0f, 0.0f) \n
    /// 
    /// \dotfile PhysXJoint6DOFLimitOptions_angular_z.dot
    ...
    ///
    /// \note NOT FULLY IMPLEMENTED YET ON THE PHYSX SIDE
    ///
    /// <b>Access type:</b> inputOutput
    /// <b>Default value:</b> Vec2f(0.0f, 0.0f) \n
    /// 
    /// \dotfile PhysXJoint6DOFLimitOptions_linearSpring.dot
    ...
    /// <b>Default value:</b> Vec2f(0.0f, 0.0f) \n
    /// 
    /// \dotfile PhysXJoint6DOFLimitOptions_angularSpring.dot
    ...
    /// 
    /// \dotfile PhysXJoint6DOFLimitOptions_breakForce.dot
    ...
    /// 
    /// \dotfile PhysXJoint6DOFLimitOptions_contactDistance.dot
