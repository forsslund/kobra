...
//
//
/// \file PhysXCollidableOptions.cpp
/// \brief Source file for PhysXCollidableOptions, X3D scene-graph node
///
//
//////////////////////////////////////////////////////////////////////////////
...
H3DNodeDatabase PhysXCollidableOptions::database( "PhysXCollidableOptions",
                                                  "PhysX3CollidableOptions",
                                                 &newInstance<PhysXCollidableOptions>, 
                                                 typeid( PhysXCollidableOptions ),
                                                 &H3DEngineOptions::database);

namespace PhysXSoftBodyOptionsInternals {
  FIELDDB_ELEMENT( PhysXCollidableOptions, convex, INPUT_OUTPUT )
  FIELDDB_ELEMENT( PhysXCollidableOptions, convexDecomposition, INPUT_OUTPUT )
  FIELDDB_ELEMENT( PhysXCollidableOptions, compacityWeight, INPUT_OUTPUT )
  FIELDDB_ELEMENT( PhysXCollidableOptions, volumeWeight, INPUT_OUTPUT )
  FIELDDB_ELEMENT( PhysXCollidableOptions, scaleFactor, INPUT_OUTPUT )
  FIELDDB_ELEMENT( PhysXCollidableOptions, nrClusters, INPUT_OUTPUT )
  FIELDDB_ELEMENT( PhysXCollidableOptions, nrVerticesPerCH, INPUT_OUTPUT )
  FIELDDB_ELEMENT( PhysXCollidableOptions, concavity, INPUT_OUTPUT )
  FIELDDB_ELEMENT( PhysXCollidableOptions, addExtraDistPoints, INPUT_OUTPUT )
  FIELDDB_ELEMENT( PhysXCollidableOptions, nrTargetTrianglesDecimatedMesh, INPUT_OUTPUT )
  FIELDDB_ELEMENT( PhysXCollidableOptions, addFacesPoints, INPUT_OUTPUT )
  FIELDDB_ELEMENT( PhysXCollidableOptions, connectDist, INPUT_OUTPUT )
  FIELDDB_ELEMENT( PhysXCollidableOptions, smallClusterThreshold, INPUT_OUTPUT )
  FIELDDB_ELEMENT( PhysXCollidableOptions, cookedFilename, INPUT_OUTPUT )
  FIELDDB_ELEMENT( PhysXCollidableOptions, saveConvexDecomposition, INPUT_OUTPUT )

  FIELDDB_ELEMENT( PhysXCollidableOptions, restOffset, INPUT_OUTPUT )
  FIELDDB_ELEMENT( PhysXCollidableOptions, contactOffset, INPUT_OUTPUT )
  FIELDDB_ELEMENT( PhysXCollidableOptions, setFlagsForAll, INPUT_OUTPUT )
  FIELDDB_ELEMENT( PhysXCollidableOptions, suppressDisabledContacts, INPUT_OUTPUT )
  FIELDDB_ELEMENT( PhysXCollidableOptions, contactShaderPairFlags, INPUT_OUTPUT )

}

PhysXCollidableOptions::PhysXCollidableOptions(
  ...
  base_url( "" ) {
  type_name = "PhysXCollidableOptions";
...
PhysicsEngineParameters::EngineOptionParameters* PhysXCollidableOptions::getParameters( bool all_params ) {
  PhysXCollidableParameters* params= new PhysXCollidableParameters( base_url );
...
void PhysXCollidableOptions::initialize() {
