...
//
//
/// \file PhysX4Joints.cpp
/// \brief Source file for PhysX4Joint classes, which maintain a link between 
...
PhysX4Joint::JointDatabase::JointMap PhysX4Joint::JointDatabase::map;

PhysX4Joint::PhysX4Joint( ConstraintParameters& jointParameters ) :
  joint( NULL ) {
  jointParameters.setConstraintId( (H3DConstraintId)this );
}

PhysX4Joint::~PhysX4Joint() {
  remove();
}

// Create a joint instance of the specified type name
PhysX4Joint* PhysX4Joint::createJoint( ConstraintParameters& jointParameters ) {
...
void PhysX4Joint::setJointFrame( const Vec3f& position, const Rotation& orientation, Body::e bodies ) {
...
Matrix4f PhysX4Joint::getJointFrame( Body::e body ) {
  PxRigidActor* actor1, *actor2;
  joint->getActors( actor1, actor2 );
...
H3DFloat PhysX4Joint::getRotation( Axis::e axis, Body::e axisRelativeTo ) {
  Vec3f localY, localX;
  switch( axis ) {
  case Axis::X:
    localY = Vec3f( 0, 1, 0 );
...
PhysX4FixedJoint::JointDatabase
PhysX4FixedJoint::database( "FixedJoint", &newInstance<PhysX4FixedJoint> );

PhysX4FixedJoint::PhysX4FixedJoint( ConstraintParameters& jointParameters ) :
  PhysX4Joint( jointParameters ) {
  PhysX4Callbacks::PhysX4SpecificData *physx_data =
    static_cast<PhysX4Callbacks::PhysX4SpecificData *>(jointParameters.getEngine()->getEngineSpecificData());
  FixedJointParameters* params = static_cast <FixedJointParameters*> (&jointParameters);

  PhysX4RigidBody* body1 = (PhysX4RigidBody*)params->getBody1();
  PhysX4RigidBody* body2 = (PhysX4RigidBody*)params->getBody2();
  ...
  joint = PxFixedJointCreate(
    *physx_data->sdk,
    actor1, PxTransform( PxIdentity ),
    actor2, PxTransform( PxIdentity ) );
...
void PhysX4FixedJoint::setParameters( ConstraintParameters& jointParameters ) {
  FixedJointParameters* params = static_cast<FixedJointParameters*> (&jointParameters);
...
PhysX4BallJoint::JointDatabase
PhysX4BallJoint::database( "BallJoint", &newInstance<PhysX4BallJoint> );

PhysX4BallJoint::PhysX4BallJoint( ConstraintParameters& jointParameters ) :
  PhysX4Joint( jointParameters ) {
  PhysX4Callbacks::PhysX4SpecificData *physx_data =
    static_cast<PhysX4Callbacks::PhysX4SpecificData *>(jointParameters.getEngine()->getEngineSpecificData());
  ...
  joint = PxSphericalJointCreate(
    *physx_data->sdk,
    body1 ? body1->getActor() : NULL, PxTransform( PxIdentity ),
    body2 ? body2->getActor() : NULL, PxTransform( PxIdentity ) );

  setParameters( jointParameters );
}

// Set the PhysX4 joint's parameters using the parameter values specified in jointParameters
void PhysX4BallJoint::setParameters( ConstraintParameters& jointParameters ) {
  BallJointParameters* params = static_cast <BallJointParameters*> (&jointParameters);
...
void PhysX4BallJoint::getParameters( ConstraintParameters& jointParameters ) {
  BallJointParameters* params = static_cast <BallJointParameters*> (&jointParameters);
...
PhysX4SingleAxisHingeJoint::JointDatabase
PhysX4SingleAxisHingeJoint::database( "SingleAxisHingeJoint", &newInstance<PhysX4SingleAxisHingeJoint> );

PhysX4SingleAxisHingeJoint::PhysX4SingleAxisHingeJoint( ConstraintParameters& jointParameters ) :
  PhysX4Joint( jointParameters ) {
  PhysX4Callbacks::PhysX4SpecificData *physx_data =
    static_cast<PhysX4Callbacks::PhysX4SpecificData *>(jointParameters.getEngine()->getEngineSpecificData());
...
// Set the PhysX joint's parameters using the parameter values specified in jointParameters
void PhysX4SingleAxisHingeJoint::setParameters( ConstraintParameters& jointParameters ) {
  SingleAxisHingeJointParameters* params = static_cast <SingleAxisHingeJointParameters*> (&jointParameters);
...
// Modify the jointParameters argument to reflect the PhysX4 joint's current parameters
void PhysX4SingleAxisHingeJoint::getParameters( ConstraintParameters& jointParameters ) {
  SingleAxisHingeJointParameters* params = static_cast <SingleAxisHingeJointParameters*> (&jointParameters);
...
PhysX46DoFJoint::PhysX46DoFJoint( ConstraintParameters& jointParameters ) :
  PhysX4Joint( jointParameters ) {
  PhysX4Callbacks::PhysX4SpecificData *physx_data =
    static_cast<PhysX4Callbacks::PhysX4SpecificData *>(jointParameters.getEngine()->getEngineSpecificData());
...
void PhysX46DoFJoint::makeAxesPerpendicular() {
  ...
  if( axis2.dotProduct( newAxis2 ) < 1 - H3DUtil::Constants::f_epsilon ) {
    Console(4) << "Warning: PhysX4 implemetation of joints only supports perpendicular axes!" << endl;
    axis2 = newAxis2;
  }
}
...
PhysX4DoubleAxisHingeJoint::JointDatabase
PhysX4DoubleAxisHingeJoint::database( "DoubleAxisHingeJoint", &newInstance<PhysX4DoubleAxisHingeJoint> );

PhysX4DoubleAxisHingeJoint::PhysX4DoubleAxisHingeJoint( ConstraintParameters& jointParameters ) :
  PhysX46DoFJoint( jointParameters ) {
  PhysX4Callbacks::PhysX4SpecificData *physx_data =
    static_cast<PhysX4Callbacks::PhysX4SpecificData *>(jointParameters.getEngine()->getEngineSpecificData());
...
// Set the PhysX4 joint's parameters using the parameter values specified in jointParameters
void PhysX4DoubleAxisHingeJoint::setParameters( ConstraintParameters& jointParameters ) {
  DoubleAxisHingeJointParameters* params = static_cast <DoubleAxisHingeJointParameters*> (&jointParameters);
  PxD6Joint* d6Joint = static_cast<PxD6Joint*>(joint);
...
// Modify the jointParameters argument to reflect the PhysX4 joint's current parameters
void PhysX4DoubleAxisHingeJoint::getParameters( ConstraintParameters& jointParameters ) {
  DoubleAxisHingeJointParameters* params = static_cast <DoubleAxisHingeJointParameters*> (&jointParameters);
...
PhysX4UniversalJoint::JointDatabase
PhysX4UniversalJoint::database( "UniversalJoint", &newInstance<PhysX4UniversalJoint> );

PhysX4UniversalJoint::PhysX4UniversalJoint( ConstraintParameters& jointParameters ) :
  PhysX46DoFJoint( jointParameters ) {
  PhysX4Callbacks::PhysX4SpecificData *physx_data =
    static_cast<PhysX4Callbacks::PhysX4SpecificData *>(jointParameters.getEngine()->getEngineSpecificData());
  ...
  // eTWIST is x, eSWING1 is y, eSWING2 is z axis in the joints' local coordinate system in PhysX4.
  // If any dof will be unlocked, first choice is eTWIST due to optimization at the PhysX4 side.
...
// Set the PhysX4 joint's parameters using the parameter values specified in jointParameters
void PhysX4UniversalJoint::setParameters( ConstraintParameters& jointParameters ) {
  UniversalJointParameters* params = static_cast <UniversalJointParameters*> (&jointParameters);
  PxD6Joint* d6Joint = static_cast<PxD6Joint*>(joint);
...
// Modify the jointParameters argument to reflect the PhysX4 joint's current parameters
void PhysX4UniversalJoint::getParameters( ConstraintParameters& jointParameters ) {
  UniversalJointParameters* params = static_cast <UniversalJointParameters*> (&jointParameters);
...
PhysX4SliderJoint::JointDatabase
PhysX4SliderJoint::database( "SliderJoint", &newInstance<PhysX4SliderJoint> );

PhysX4SliderJoint::PhysX4SliderJoint( ConstraintParameters& jointParameters ) :
  PhysX4Joint( jointParameters ),
  ...
  PhysX4RigidBody* body2 = (PhysX4RigidBody*)params->getBody1();
  PhysX4RigidBody* body1 = (PhysX4RigidBody*)params->getBody2();
...
PhysX4SliderJoint::~PhysX4SliderJoint() {
  remove();
}

// Set the PhysX4 joint's parameters using the parameter values specified in jointParameters
void PhysX4SliderJoint::setParameters( ConstraintParameters& jointParameters ) {
  SliderJointParameters* params = static_cast <SliderJointParameters*> (&jointParameters);
  ...
  if( params->haveSliderForce() ) {
    ...
    if( simulationCallbackId < 0 ) {
      if( slider_force != 0 )
        simulationCallbackId = params->getEngine()->asynchronousCallback( &PhysX4SliderJoint::updateSlider, this );
...
// Modify the jointParameters argument to reflect the PhysX4 joint's current parameters
void PhysX4SliderJoint::getParameters( ConstraintParameters& jointParameters ) {
  SliderJointParameters* params = static_cast <SliderJointParameters*> (&jointParameters);
...
H3DUtil::PeriodicThread::CallbackCode PhysX4SliderJoint::updateSlider( void *data ) {
  static_cast <PhysX4SliderJoint*> (data)->update();
  return H3DUtil::PeriodicThread::CALLBACK_CONTINUE;
}

// Member function called by static callback, used to update motor simulation
void PhysX4SliderJoint::update() {
...
PhysX4DistanceJoint::JointDatabase
PhysX4DistanceJoint::database( "DistanceJoint", &newInstance<PhysX4DistanceJoint> );

PhysX4DistanceJoint::PhysX4DistanceJoint( ConstraintParameters& jointParameters ) :
  PhysX4Joint( jointParameters ) {
  PhysX4Callbacks::PhysX4SpecificData *physx_data =
    static_cast<PhysX4Callbacks::PhysX4SpecificData *>(jointParameters.getEngine()->getEngineSpecificData());
...
void PhysX4DistanceJoint::setParameters( ConstraintParameters& jointParameters ) {
  DistanceJointParameters* params = static_cast <DistanceJointParameters*> (&jointParameters);
...
// Modify the jointParameters argument to reflect the PhysX4 joint's current parameters
void PhysX4DistanceJoint::getParameters( ConstraintParameters& jointParameters ) {
  DistanceJointParameters* params = static_cast <DistanceJointParameters*> (&jointParameters);
  PxDistanceJoint* distanceJoint = static_cast<PxDistanceJoint*>(joint);
  ...
  if( params->haveDistance() ) {
    ...
    // by physx4 is the squared distance.
...
PhysX4Generic6DofJoint::JointDatabase
PhysX4Generic6DofJoint::database( "Generic6DOFJoint", &newInstance<PhysX4Generic6DofJoint> );

PhysX4Generic6DofJoint::PhysX4Generic6DofJoint( ConstraintParameters& jointParameters ) :
  PhysX46DoFJoint( jointParameters ),
...
// Set the distance joint's parameters using the parameter values specified in jointParameters
void PhysX4Generic6DofJoint::setParameters( ConstraintParameters& jointParameters ) {
  ...
  // Limitations of limits in PhysX4: v3.3.1:
...
// Modify the jointParameters argument to reflect the PhysX4 joint's current parameters
void PhysX4Generic6DofJoint::getParameters( ConstraintParameters& jointParameters ) {
