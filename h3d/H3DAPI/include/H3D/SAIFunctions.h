  ...
  namespace SAI {
    ...
    struct H3DAPI_API ExecutionContext: public H3DUtil::RefCountedClass {
      ExecutionContext( bool _clean_up = false ) :
        clean_up( _clean_up ) {
        DEFNODES_DEBUG_NAME( named_nodes, "SAI::ExecutionContext::named_nodes")
        DEFNODES_DEBUG_NAME( exported_nodes, "SAI::ExecutionContext::exported_nodes")
        AUTOREF_DEBUG_NAME( root_node, "SAI::ExecutionContext::root_node")
