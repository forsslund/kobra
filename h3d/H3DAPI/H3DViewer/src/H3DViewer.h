...
class TreeViewDialog : public wxFrame 
{
	...
	protected:
		...
		virtual void OnStopUpdatingCheckbox( wxCommandEvent& event ) { event.Skip(); }
	...
	public:
		...
		wxCheckBox* stop_treeview_update_checkbox;
...
class MenuContainer : public wxFrame 
{
	...
	protected:
		...
		virtual void OnTreeViewShowNodeReferences( wxCommandEvent& event ) { event.Skip(); }
