...
TreeViewDialog::TreeViewDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	bSizer8->Add( search_text_ctrl, 1, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	case_sensitive_checkbox = new wxCheckBox( this, wxID_ANY, wxT("Case\nsensitive"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer8->Add( case_sensitive_checkbox, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	focus_search_result_checkbox = new wxCheckBox( this, wxID_ANY, wxT("Focus on\nsearch result"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	stop_treeview_update_checkbox = new wxCheckBox( this, wxID_ANY, wxT("Stop \nupdating"), wxDefaultPosition, wxDefaultSize, 0 );
	stop_treeview_update_checkbox->SetToolTip( wxT("Stop updates of tree structure, labels will continue to update") );
	
	bSizer8->Add( stop_treeview_update_checkbox, 0, wxALL, 5 );
	
	ProfileCheckbox = new wxCheckBox( this, wxID_ANY, wxT("Show\nprofiling"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	bSizer8->Add( btnClose, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	...
	stop_treeview_update_checkbox->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( TreeViewDialog::OnStopUpdatingCheckbox ), NULL, this );
...
TreeViewDialog::~TreeViewDialog()
{
	...
	stop_treeview_update_checkbox->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( TreeViewDialog::OnStopUpdatingCheckbox ), NULL, this );
...
MenuContainer::MenuContainer( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	wxMenuItem* TreeViewShowReferences;
	TreeViewShowReferences = new wxMenuItem( RightClickMenu, wxID_ANY, wxString( wxT("Show node references") ) , wxEmptyString, wxITEM_NORMAL );
	RightClickMenu->Append( TreeViewShowReferences );
	...
	wxMenuItem* TreeViewShowReferences11;
	TreeViewShowReferences11 = new wxMenuItem( RightClickMenuTexture, wxID_ANY, wxString( wxT("Show node references") ) , wxEmptyString, wxITEM_NORMAL );
	RightClickMenuTexture->Append( TreeViewShowReferences11 );
	...
	wxMenuItem* TreeViewShowReferences1;
	TreeViewShowReferences1 = new wxMenuItem( RightClickMenuGeometry, wxID_ANY, wxString( wxT("Show node references") ) , wxEmptyString, wxITEM_NORMAL );
	RightClickMenuGeometry->Append( TreeViewShowReferences1 );
	...
	this->Connect( TreeViewShowReferences->GetId(), wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( MenuContainer::OnTreeViewShowNodeReferences ) );
	...
	this->Connect( TreeViewShowReferences11->GetId(), wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( MenuContainer::OnTreeViewShowNodeReferences ) );
	...
	this->Connect( TreeViewShowReferences1->GetId(), wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( MenuContainer::OnTreeViewShowNodeReferences ) );
}
...
MenuContainer::~MenuContainer()
{
	...
	this->Disconnect( wxID_ANY, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( MenuContainer::OnTreeViewShowNodeReferences ) );
	this->Disconnect( wxID_ANY, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( MenuContainer::OnTreeViewCollapseAll ) );
	this->Disconnect( wxID_ANY, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( MenuContainer::OnTreeViewExpandAll ) );
	this->Disconnect( wxID_ANY, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( MenuContainer::OnTreeViewCollapseChildren ) );
	this->Disconnect( wxID_ANY, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( MenuContainer::OnTreeViewDeleteNode ) );
...
PythonConsole::PythonConsole( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_textCtrlOutput->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), wxFONTFAMILY_TELETYPE, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString ) );
	...
	m_textCtrlInput->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), wxFONTFAMILY_TELETYPE, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString ) );
