  ...
  displayed_node( NULL )
{
  ...
  AUTOREF_DEBUG_NAME( displayed_node, "H3DViewerFieldValuesDialog::displayed_node")
  ...
  FieldValuesGrid->Connect( wxEVT_GRID_CELL_CHANGED, wxGridEventHandler( H3DViewerFieldValuesPanel::OnCellEdit ), NULL, this );
#else
...
#if (wxMAJOR_VERSION >= 3)
  FieldValuesGrid->Disconnect( wxEVT_GRID_CELL_CHANGED, wxGridEventHandler( H3DViewerFieldValuesPanel::OnCellEdit ), NULL, this );
#else
